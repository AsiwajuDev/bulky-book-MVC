...
namespace BulkyBookMVC.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //check if company user role exists
                    ...
                    //check if individual user role exists
                    ...
                    else
                    {
                        ...
                        {
                            //admin wants to register a new user
